...
-- autosave (now done way better on formatting)
--[[ vim.api.nvim_exec([[
	augroup autosave
		autocmd!
...
-- show linenr on focus
vim.api.nvim_exec([[
	augroup AbeNumbertoggle
		autocmd!
...
vim.api.nvim_exec([[
	augroup AbeNewline
		autocmd!
		autocmd BufWritePre * if getline('$', '$')[0] != '' | call append(line('$'), '') | endif
	augroup END
]], true)
